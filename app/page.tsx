      ...
      <section className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="space-y-5">
            <h1 className="max-w-4xl font-display text-5xl leading-[0.94] tracking-[-0.05em] text-stone-950 sm:text-7xl lg:text-[6.5rem]">
              AutoTestGen AI
            </h1>
            ...
            <p className="max-w-2xl text-sm leading-7 text-stone-600">
              Paste a URL, let the platform scan the DOM, and receive runnable
              QA scripts tailored for modern automation frameworks.
            </p>
          </div>
